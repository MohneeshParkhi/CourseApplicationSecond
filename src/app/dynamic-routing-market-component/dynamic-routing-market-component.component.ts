...
import {Album} from './album-details/album.model';
@Component({
  selector: 'app-dynamic-routing-market-component',
  templateUrl: './dynamic-routing-market-component.component.html',
  styleUrls: ['./dynamic-routing-market-component.component.css']
})
export class DynamicRoutingMarketComponentComponent implements OnInit {
...
albums:Album[]=[new Album("Pulse", "Pink Floyd",
